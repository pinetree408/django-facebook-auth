...
class DemoUserDetail(TemplateView):
    template_name = "demo_detail.html"

    def get_context_data(self, **kwargs):
        context = super(DemoUserDetail, self).get_context_data(**kwargs)
...
class DemoLogin(FacebookLoginMixin, View):
    template_name = "demo_login.html"


class DemoLogout(View):
